...
<div class="xtra_btn_top" style="padding-left:10px;">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                   ...
                   <?php  $select_hub = mysql_query('SELECT * FROM cse_count GROUP BY `hubname`'); 
				   while($fetch_hub = mysql_fetch_array($select_hub)){
					   ?>
					   <option value="<?php echo $fetch_hub['hubname'];?>"><?php echo $fetch_hub['hubname'];?></option>
					   <?php
				   } ?>					   
					...
					<?php	
						...
						$zipcode = explode(',',$pincode);
						for($i=0; $i<count($zipcode); $i++)
						{?>
						 <div id="dynPincode">
						 <label class="col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label" for="price"></label><div class="form-group"><div class="col-lg-3 col-md-6 col-sm-6 col-xs-12"><input type="number" name="zipcode[]" id="zipcode1" value="<?php echo $pincode1 = $zipcode[$i];?>" class="form-control" autocomplete="off" /><br></div></div></div>
						 <?php
					 }}*/
					?>
