				...
				<form class="cmxform form-horizontal tasi-form" id="" method="post" action="productdelete.php">
					<section class="panel">
							...
							<section id="flip-scroll">
								<table class="display table table-bordered cf" id="dyntable">
									...
									<tbody>
										...
										$query = mysql_query("SELECT * FROM sales_old WHERE `cat`='$dept1' AND `saleorder_id`='$salesid'");
										...
										<tr>
											...
											<?php $change_qty = mysql_fetch_array(mysql_query("SELECT * FROM sales_old WHERE `cat`='$dept1' AND `saleorder_id`='$salesid' AND product='$prodid'"));
											?>
						...
						<footer class="panel-footer">
							...
							<?php   
							 $query1 = mysql_query("SELECT * FROM sales_old WHERE `cat`='$dept1' AND `saleorder_id`='$salesid'");
