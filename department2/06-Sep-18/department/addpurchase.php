...
<div class="panel-body">
	...
	<form class="cmxform form-horizontal tasi-form" id="product" method="post" name="product" enctype="multipart/form-data" >
		...
		<div class="form-group">
			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
				 <select required name="brandname" id="brandname" class="form-control " onchange="product_expand(this.value,<?php echo $dept1;?>,sub_categoryname.value)" >
				 <option value="">--- Select ---</option>
...
?>									
			...
			<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
				...
				<select required name="product_name" id="product_name" class="form-control" onchange="product_price(this.value,<?php echo $dept1;?>,sub_categoryname.value,brandname.value)" >
				<option value="">--- Select ---</option>
					<?php 
					if($product_name != "")
					{
				   $ca=mysql_query("SELECT * FROM `product` WHERE  `dept`='$dept' AND `brandname`='$brandid' AND `status`=1");
					while($cat=mysql_fetch_array($ca)){ ?>
...
?>
		...
		<div class="form-group">
			...
			<label class="col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label" for="commission">Commmission <span class="red">*</span></label>
			<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
				<input required type="number" name="commission" id="commission" value="<?php echo $commission;?>" class="form-control" autocomplete="off" readonly />
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label" for="gst">GST (%)<span class="red">*</span></label>
			<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
			  <input required type="text" name="gst" id="gst" value="<?php echo $gst;?>" class="form-control" autocomplete="off" readonly />
			</div>
		<label class="col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label" for="commission">Stock <span class="red">*</span></label>
			<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
				<input required type="number" name="stock" id="stock" value="<?php echo $stock;?>" class="form-control" autocomplete="off" />
