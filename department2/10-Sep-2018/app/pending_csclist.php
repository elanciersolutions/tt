<?php  include("../admin/connect/config.php");
	   ...
	   $cscid = mysql_query("select * from sales  where delivery_to_csc_status=0 and approve_status=1");
	   
	   $num = mysql_num_rows(mysql_query("select * from sales where delivery_to_csc_status=0 and approve_status=1"));
