...
<select name="sub_categoryname" id="sub_categoryname" class="form-control selectpicker" data-show-subtext="true" data-live-search="true" onchange="brand_fetch(this.value,category.value )" >
				<option value="">--- Select ---</option>
					<?php
