...
if(isset($_POST['submit'])){
	...
	mysql_query("INSERT INTO `category` (`category`,`image`,`date`,`dtime`,`dept`) VALUES ('$category','$img','".date('Y-m-d')."','".date('Y-m-d H:i:s')."','$dept')");
					...
					<section class="panel">
                        ...
                        <div class="panel-body">
							<?php 
							 ...
							 $sql=mysql_fetch_array(mysql_query("SELECT * FROM `category` WHERE id='$id'")); extract($sql);?>
									...
									<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="fileupload-new thumbnail">
												<?php if($_GET['id']!=''){ ?>
												<img src="image/category/<?php echo $image;?>" alt="<?php echo $category;?>" />
