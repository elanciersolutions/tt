...
<tbody>
	...
	<tr id="<?php echo $i;?>" onchange="product_success(<?php echo $result['id'];?>,'<?php echo $result['pname'];?>',<?php echo $i;?>);price_success(<?php echo $result['id'];?>,<?php echo $result['price'];?>,<?php echo $i;?>)">
		...
		<td><?php $subcategory = $result['subcategory'];
		  $subname = mysql_fetch_array(mysql_query("SELECT * FROM sub_category WHERE id='$subcategory'")); echo  $subname['sub_categoryname'];?></td>
...
<!--<form id="del_prod" action="test.php" method="Post">
