				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li><a href="javascript:;"><i class="icon-manage"></i><span style="font-size:12px;">Product Mgmt</span></a>
						<ul class="sub-drop">
							...
							<li><a href="subcategory_list.php"><i class="icon-ad"></i><span>Subcategory</span></a></li>
							<li><a href="brand_list.php"><i class="icon-ad"></i><span>Brand</span></a></li>
					...
					<li><a href="csv_list.php"><i class="icon-report"></i><span>CSC</span></a></li>
