...
if(isset($_POST['submit'])){
	...
	$in = mysql_query("INSERT INTO `category` (`category`,`image`,`department`,`dept`) VALUES ('$category','$img','$dept[1]','$dept[0]')");
	if($in){
...
if(isset($_POST['update'])){
	...
	$in=mysql_query("UPDATE `category` SET `category`='$category',`image`='$img',`dept`='$dept[0]',`department`='$dept[1]' WHERE `id`='$id'") ;
	if($in){
		echo "<script type='text/javascript'>swal({
