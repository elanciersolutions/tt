		...
		<section id="flip-scroll">
			<table class="display table table-bordered cf" id="dyntable">
				...
				<tbody>
					...
					$brnad = mysql_query("SELECT * FROM brand WHERE `dept`='$dept1' ORDER BY `id` DESC");
					...
					<tr>
						...
						$subname = mysql_fetch_array(mysql_query("SELECT * FROM sub_category WHERE `id` ='$subid'")); 
						echo  $subname['sub_categoryname'];?></td>
