...
$in = mysql_query("INSERT INTO `sub_category` (`dept`,`category`,`sub_categoryname`,`date`,`dtime`,`catid`,`department`) VALUES ('$dept','$category[1]','$sub_categoryname','".date('Y-m-d')."','".date('Y-m-d H:i:s')."','$category[0]','$department')");
if($in)
{
