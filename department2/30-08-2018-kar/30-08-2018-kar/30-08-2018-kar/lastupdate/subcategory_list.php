								...
								<table class="display table table-bordered cf" id="dyntable">
									...
									<tbody>
										...
										<tr>
											...
											<input type="checkbox" checked data-toggle="toggle" data-on="Ready" data-off="Not Ready" data-onstyle="success" data-offstyle="danger" onclick="app_status(1,<?php echo $dept1;?>,<?php echo $result['id'];?>)" id="disable">
											<?php } else if($result['appstatus']==0){?>
											<input type="checkbox"  data-toggle="toggle" data-on="Ready"  data-onstyle="success" data-off="Not Ready"  data-offstyle="danger" onclick="app_status(0,<?php echo $dept1;?>,<?php echo $result['id'];?>)" id="enable">
											<?php } ?></td>
