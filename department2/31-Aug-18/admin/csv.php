...
if(isset($_POST['submit'])){
	extract($_POST);	
	mysql_query("INSERT INTO `sponser` (`incharge_name`,`pancard`,`adhar`,`phone`,`sponsername`,`sponserid`,`date`,`dtime`,`sp_password`) VALUES ('$incharge_name','$pancard','$adhar','$phone','$sponsername','$sponserid','".date('Y-m-d')."','".date('Y-m-d H:i:s')."','$sp_password')");
...
<h2><?php if($_GET['id']!=''){ echo "Update"; } else{ echo "Add"; } ?>  CSV Creation</h2>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="cmxform form-horizontal tasi-form" id="" method="post" name="product" enctype="multipart/form-data" >
								...
								<div class="form-group">
									...
									<label class="col-lg-3 col-md-4 col-sm-4 col-xs-12 control-label" for="commission">Modile <span class="red">*</span></label>
									<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
