...
<html lang="en">
  <head>
    ...
    <title> <?php echo $title;?> | Do First CSV</title>
...
<body>    
	<section id="container">
		<header class="header white-bg">
			...
			<h3><?php  if($dept) { $y00=mysql_fetch_array(mysql_query("SELECT `name` FROM `csv` WHERE `id`='$dept'")); echo $y00['name'];?> 
			<?php } ?></h3>
			</div>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				<ul class="sidebar-menu" id="nav-accordion">
					<li><a href="dashboard.php"><i class="icon-dashboard"></i><span>CSV Dashboard</span></a></li>
