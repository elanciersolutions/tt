								...
								<table class="display table table-bordered cf" id="dyntable">
									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center"><input type="text" name="edit_qty"  value="<?php
									        echo $qty = $result['qty']; ?>" id="edit_qty<?php echo $tableid=$result['id'];?>" style="width:50px;text-align:center;"readonly onkeyup="edit_salesorder(<?php echo $salesid;?>,<?php echo $price;?>,<?php echo $prodid;?>,<?php echo $tableid=$result['id'];?>,this.value,<?php echo $result['qty'];?>,<?php
											...
											<td><a onclick="editqty(<?php echo $tableid=$result['id'];?>)" class="block_tip tooltips"><i class="fa fa-pencil"></i></a></td>
