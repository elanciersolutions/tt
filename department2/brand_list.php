							...
							<section id="flip-scroll">
								<table class="display table table-bordered cf" id="dyntable">
									...
									<tbody>
										...
										$brnad = mysql_query("SELECT * FROM brand WHERE dept='$dept1' ");
										
										$i=1; while($result=mysql_fetch_array($brnad)) { ?>		
										<tr>
											<td class="text-center"><?php echo $i;?></td>
											<td class="text-center"><?php //$catid = $result['category'];
											//$catename = mysql_fetch_array(mysql_query("SELECT * FROM category WHERE dept='$dept1' and id='$catid' ")); echo  $catename['category']; 
											$departmen = mysql_fetch_array(mysql_query("SELECT * FROM department WHERE id='$dept1'")); echo  $departmen['department'];?></td>
