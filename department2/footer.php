	...
	/*********** Find SubCategory  ***************/
		...
		function dynamic_purchase(pname,price,gst,commission,stock,tr_count,subname,brandname)
		{
			...
			var data = '<tr><td>'+tr_count+'</td><td>'+pname[1]+'<input type="hidden" name="pname[]" value="'+pname[1]+'"></td><td>'+price+'<input type="hidden" name="price[]" value="'+price+'"></td><td>'+gst+'<input type="hidden" name="gst[]" value="'+gst+'"></td><td>'+commission+'<input type="hidden" name="commission[]" value="'+commission+'"></td><td>'+stock+'<input type="hidden" name="stock[]" value="'+stock+'"><input type="hidden" name="subname[]" value="'+subname+'"><input type="hidden" name="brandname[]" value="'+brandname+'"></td><td><button><i class="fa fa-danger"></button></td></tr>';
